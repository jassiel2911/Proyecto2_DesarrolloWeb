...
<main class="container main-crear-curso text-md-center">
		<!-- Title -->
		<h1 class="mt-4 mt-sm-5 text-pink mb-xl-4">Crear reseña</h1>
		<div class="mt-md-4 mt-4">
            ...
            @csrf
				...
				<label class="d-block text-left">Fecha de publicacion</label>
				...
				<input type="submit" value="Crear" id="submit" class="btn btn-primary bg-pink text-dark">

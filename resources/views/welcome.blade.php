...
<body class="body-welcome p-3 center">
	...
	<h1 class="text-center mt-4 pt-2"><span>¡</span>Bienvenido <span></span></h1>
	<h2 class="text-center text-darkgrey mt-4">Inicia sesión</h2>
    ...
    @csrf
		...
		<a href="{{route('register')}}" class="text-right text-darkgrey form-label-link">¿No tienes cuenta? Regístrate aqui</a>

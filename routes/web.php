...
Route::get('viajes',[App\Http\Controllers\EntregaController::class, 'viajes'])->name('viajes');


Route::get('autor',[App\Http\Controllers\EntregaController::class, 'autor'])->name('autor');

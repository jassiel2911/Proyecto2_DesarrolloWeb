...
<main class="container">
		...
		<div class="home-title row">
			<div class="home-title_text pl-3 mr-5">
				<h1 class="mt-4 mt-sm-5 text-ydark ">Blog de Viajes</h1>
				<a href="{{route('admintareas.create')}}">Agregar Nueva Experiencia</a>
			</div>
		</div>
		<hr>
		<!-- Cursos <0 -->
				...
				<div class="col mb-4">
					<div class="card h-100 bg-yellow p-3 p-xl-4">
						...
						<div class="cursoadmin-index_botones d-flex">
							<a class="bg-amarillo mr-md-3" href="{{route('admintareas.show',$tarea->id)}}">Ver</a>
							<a class="bg-amarillo mr-md-3" href="{{route('admintareas.edit',$tarea->id)}}">Editar</a>
